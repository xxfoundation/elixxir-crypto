...
func TestGenerateSharedKey(t *testing.T) {
	...
	secretSeedKey := cyclic.NewIntFromString("ef9ab83927cd2349f98b12378"+
		"89909002b897231ae9c927d1792ea0879287ea3", 16)

	println("ssk bitlen:", secretSeedKey.BitLen())
	outSharedKey := cyclic.NewMaxInt()

	baseKey := cyclic.NewIntFromString("da9f8137821987b978164932015c105"+
		"263ae769310269b510937c190768e2930", 16)
	...
	GenerateSharedKey(&g, baseKey, secretSeedKey, outSharedKey, outSharedKeyStorage)
