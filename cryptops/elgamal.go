...
type ElGamalPrototype func(g *cyclic.Group, keyInv, privatekey, publicCypherKey, ecrKeys, cypher *cyclic.Int)
...
var ElGamal ElGamalPrototype = func(g *cyclic.Group, keyInv, privateKey, publicCypherKey, ecrKeys, cypher *cyclic.Int) {
	tmp := g.NewMaxInt()
