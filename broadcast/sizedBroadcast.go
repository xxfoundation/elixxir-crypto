...
// Message field sizes.
const (
	// sizeSize is size of the size field
	sizeSize = 2

	// minimumPadding is the minimum number of bytes of random padding that will
	// be appended to a message
	minimumPadding = 8

	// sizedBroadcastMinSize is the size of all the extra space in the packet
...
const (
	// NewSizedBroadcast
	errNewSizedBroadcastMaxSize = "size of payload and its size %d too large " +
		"to fit  in max payload size %d"
