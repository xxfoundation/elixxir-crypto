...
// Uses the standard RSA implementation
...
func (priv *private)SignPKCS1v15(random io.Reader, hash crypto.Hash,
...
func (priv *private)DecryptOAEP(hash hash.Hash, random io.Reader, ciphertext []byte,
...
func (priv *private)DecryptPKCS1v15(random io.Reader,ciphertext []byte) ([]byte, error){
...
func (priv *private)DecryptPKCS1v15SessionKey(random io.Reader,
	ciphertext []byte, key []byte) error{
	return gorsa.DecryptPKCS1v15SessionKey(random, &priv.PrivateKey, ciphertext,
		key)
}
...
func (priv *private)GetOldRSA()*oldrsa.PrivateKey{
	return &oldrsa.PrivateKey{priv.PrivateKey}
}
