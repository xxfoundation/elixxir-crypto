...
func TestConstructIdentity_Vector(t *testing.T) {
	...
	expectedCodeNames := []string{
		...
		"mateGrenadianMonocarp#IGXyptJWwIEvodXOQelrok5/I+d6Wv0xFFE87C",
		"gentlemanShiftingPachytene#JHfoarwsvjQMY5iZypfxQPBoa+US3T0xFDEEF4",
		"coachMindedStubble#J7sDlY7bHn8Iu3XPte6pga5ZaWLfT20xF6358A",
		"thatTherapeuticalAlert#y8mnzmlzQVUMPgMByUtpV1X8HNdp/m0x56A5EC",
		"hisImbricateGeneral#0OQddD1SY9IOyfoFDtGXquChG/kCXt0xE18B6B",
		"thatScentlessWindshield#VQB+elebg54sG1o9AyzDiSDIGKo6S70xB041FF",
		"representativeRecessionarySoundReflection#u0P0nkNbHDMHi12fwtSISDW3wxEBDs0xC5908E",
		"brotherOverseasPanhysterectomy#iIvJy9nuiJg7H3TLwumyN37vtTrdr60xE238EC",
		...
		"djCrustaceousJosephBlack#+0kY0+W/mN9Vk8fOk536zGFu5JVi6K0xF88017",
		"senoraTransformableDeceiver#7/U4P2FKBAaHX7CquQ3oQac1++aBY+0xB041FF",
		"aConicJohnDewey#G6omqBoKDTL4NFpic5P+IpuKkfbbeY0xA74AC7",
		"msUnqualifiedModification#du1ojRiL7pU4Owq4o1cjK7qzYBX5tR0x4CC417",
		"motivativeWatershed#7IspUGfv8lFjf3j9pxI9aN2xiiQGE40x48CCCD",
		"hisUntemperedTwelvemonth#XVECxCH7ZPU5qCsyLgnnDwmUWsT4P00xE9AB17",
		"brotherVexedQuarryman#oTPqAD4ZVfSI9u+6NnA2HBDwmoMiq20xCA226B",
		"technicianValidatedEroding#CBhMFc2S4EsMaOF361VVjJugepEEbU0xF75D59",
		"codelingAuditoryPicketFence#UyJJFRRYjaOjJ78pQ5nMV9wxKGCSqN0xE41B17",
		"mcUnbefittingPhyllostachys#Fx+XJnd3aongZqcaXJtAFyUYUTlYpD0xFFFC17",
		"gentlemanAlertPinkness#8VDrAkNQomebVKsa+BRR7+QOUtFcS10xECD672",
		"foremanOutlyingBamboo#ON7m/yKsp8nIWK3XnrT5+x+Lcv8MnP0xC7A317",
		"constableDegenerateSannup#TQDfTRTkRtk17mC66/V5V1h6Lmxtnj0x00FFFF",
		...
		"broEyeDeceivingReadability#n7WfNv5sU7k14YwnKvkbSEe1Q+ZbA20xE56E94",
		...
		"ladyNiloticStonehenge#YZN14FDNGhfrvglD2fbF4h1Wjtn9LW0x48CCCD",
		"aWellKnownWellFoundedSepiidae#8es/JqPu6qTL6N5VTwD3udCa2X5sGN0x5EFB6E",
		"testerOpenheartedEdentata#8GTh/1guvSfcHdg7u6+2Z6kCKHQqgD0xFFF8C6",
		"thisAloofEmbrace#gKckIJS6r+Fr5KJ7UmP+cnCgENCxVR0x57FEFF",
		"msUntaggedPurge#jKXmp0xHki2DDaYGuzrJxT3Buyw0r30xC6AEC7",
		"clerkRhapsodicAcrostic#9iW47PUFZobB40jLa/Ircd15R9UOX40xF665AB",
		"madamPrecariousAshtoreth#AiHgclVykhE117QZLUsLDe3PyaiL//0xF75D59",
		"activistWellTriedGayal#kOAubHhdI4YSiddHZtiaxVz5L30VQs0xE41B17",
		"ourPermutableLablab#jLoLArQEWCO0mijjlszerWYgUAp0c20xF6358A",
		"ourUnstoppableMsec#/Ly7aeiOzDfxarK0JdB5ub/o5SJ9J+0x43BFC7",
		"seniorScandalousWilfulness#sfuEVKCLqg0ZU2e9dpk+TowWfxDnrU0x7FE817",
		"aParticularGovernmentalLinebacker#RhkPV4oeDc4MQJj29OdER51O1TBJJe0x52D017",
		...
		"aWellKnownMordantPicnic#s5CDyaJCyflp94Nht60BgMynfQIxt60x64E986",
		"mistressXerographicGuardianship#oSpGyMiORey7lqbIAcgL2H5MTWs87n0x00FFFF",
		...
		"fledglingOuterHelicopter#CFBonykLjYHMzGESusgET+ojZXnXy+0x3EA99F",
		...
		"technicianSmallGrainedPlatform#6eNDFseaT07bWJ7XbhxUi4hadmGWkO0x3EA99F",
		"monsieurFundedFalseBelief#nD+VIRKJFpOVjm8jnTjLXLwkWNVHoJ0xC68E17",
		"technoBullQuintessentialDisciplesOfChrist#UcEhk455MmNyx8aZv/ninLoGk+t9+H0xC48793",
		"jrCalcicolousStaff#9ONAWOcBCb32QvAq2XAZRjt82iA7us0xC25A7C",
		"theBlightedFiligree#D6DvIW4Ett7mAm9yPrqzudLYCiVqCQ0xC12267",
		"sergeantUnreactiveAnxiolytic#6f+VMw9K669bzC7+Yhg+WzEg8UZWnW0xB38481",
		"herObliqueBestFriend#dC3bCc9Pnum6PJ6FZbxAdaqgK/OgDa0xE18B6B",
		"djMunificentMottle#t3GIfdsaml800cqHQovmhY6CapFW9V0x54C571",
		"theirClearYhvh#CxgaD4atGCC2ySR1FUjbuVNEgy5aBP0x57FEFF",
		"scriptKiddieArchingParameter#AosH51cvf16D7e+ngycHz1qMafxaED0xF75D59",
		"programmerLetteredRailwayLine#R3nMp5DTaVJ7lM7AivOpMQGfEedlPA0xB38481",
		"chiefShamMycelium#MgfelOEBdci1MYxvCFVg+GOmXYesRv0xE7A1B0",
		"tiaRelativeReenforcement#xET81e2mef+GNsepulMKS4qHzVNXg80x8AFB17",
		"herOutfittedAldol#cazZBzanh8y0/pH5oFsKX3kggDYUhC0x00FFFF",
		"sorceressBriaryUsufruct#nEax3bLPHQnUGeKB0XAKAZWKbIXrMY0x1589FF",
		...
		"padronNimbleTulip#GVptxNdWnI5ExW1xizO/AojF17oD/90xE6A9EC",
		"padreWhackedParaphysis#LUVWIV8khBXd6nZRPRaQuiHO5g0XOs0x1589FF",
		"monsieurCeremoniousMattock#9Qv4vcwkBAvj6x6qOUyYfPP0nFKKv/0xFF0000",
		"theirProjectingDuette#DPL5HrXuemKD4fTUIyxGBUBFrP4L5f0xC12267",
		"gentlemanTwentySixRush#04XTUr4bdtfuXRlgvqHaydSoI8jrvB0x488AC7",
		...
		"aWellKnownSceptredPepperoni#foDth/e4qEuDMA1UspMlolAIxSoEN20xF433FF",
		"apprenticeWoolyMindedChlorenchyma#38S9/zpJ77bnc3jQnxwfsi8ouVF/St0xFBB117",
		"programmerUnthankfulHeraldry#DBBH33YolG+cJGN44VGw2qSM8M/7s80x893BFF",
		"theHonorableVerbalDelinquent#MH5UXonBleimbDRmDyXGfDArXdOJQk0xE9AB17",
		"myAmokOpenLetter#g8AmNtoK4/ympAKDGqdtOmPJ0JW/PR0xC58917",
		"ourUnstagedAttrition#5xrdkIFsHGxYApAvWKcXRZg2KN06jX0x87F717",
		"yourAftermostFencingMaterial#GS3iJ2W6bs7VnnKOQwa2o2iTgGqTAi0x59E817",
		"recruitPracticalChrysalis#/usy7acxjOL2kPx7JJLFZe9HtTC5Sr0xF6358A",
		"actorOldenOligarch#nLDg1OX2lbDIE7/0G+S8AZxUsvYsME0x8AFB17",
		"inspectorUncomparableCraft#0Z0odw3VMwPGO38jLhSu719UTpIpIq0x8BB381",
		"juniorArborousRobin#PJ/HxMkKXOlxwbnJXcWy/uE+1BfIcI0xE77471",
		"spectreCeilingedLeaveOfAbsence#kuMUS/CM7x6Kmug2ZhSA7kq7xkC42W0xC9BE62",
		"scriptKiddieUnanticipatedAbiesVenusta#Dj1d5Jr6U/dm5F3p1BThm0eRtOrsgK0xFAAFBA",
		"theExegeticalDisparagement#xgvcUcqQxezQPNi5vAYE1a/c+H3MAo0xC12283",
