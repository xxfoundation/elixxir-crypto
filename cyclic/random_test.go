...
func TestRand(t *testing.T) {
	...
	// 6 less than max
	largeMin := large.NewIntFromString("oi2n40g27kmjfdkkn332lg1eep4ji585egipan1ap1l70jbk008ib5k"+
		"n96aj38ej5nc99infk3j5mhlfbibhlnm9p0c180pengk4m8977i6l9m44be2p85ejl"+
		"j5oilp1b5bp8ffdm5g1bff562jii0kjmni4kinphma7a0981debkk4g19h01iii4m6"+
		"oklf9fkc1d6j7jn2bgn82mkjlha7gojoolm7oi6m1p015d15jogel3pg3ff57bm717o"+
		"74lk0ij9moo9cna40bl7jl07fp48k3n8oidnb4gd3cld05aee4i3j25i95ej97cfhbdg"+
...
// Tests Rand function panics when an error occurs while reading from system
func TestRand_Panic(t *testing.T) {
	max := large.NewInt(0)
	max.SetString("oi2n40g27kmjfdkkn332lg1eep4ji585egipan1ap1l70jbk008ib5k"+
		"n96aj38ej5nc99infk3j5mhlfbibhlnm9p0c180pengk4m8977i6l9m44be2p85ejl"+
		"j5oilp1b5bp8ffdm5g1bff562jii0kjmni4kinphma7a0981debkk4g19h01iii4m6"+
	...
	smallMin := large.NewInt(2)
	smallGen := NewRandom(smallMin, max)
	smallGen.reader = AlwaysErrorReader{}
	rand := large.NewInt(0)

	defer func() {
		if r := recover(); r == nil {
			t.Errorf("Rand should panic on reading error")
		}
	}()
...
func TestSetMin(t *testing.T) {
	tests := 1
	pass := 0
	gen := NewRandom(large.NewInt(0), large.NewInt(10))
	gen.SetMin(large.NewInt(5))
	// expected fmax
	expected := large.NewInt(6)
	actual := gen.fmax
...
func TestSetMax(t *testing.T) {
	tests := 1
	pass := 0
	gen := NewRandom(large.NewInt(6), large.NewInt(10))
	gen.SetMax(large.NewInt(16))
	// expected fmax
	expected := large.NewInt(11)
	actual := gen.fmax
	if actual.Cmp(expected) != 0 {
...
func TestSetMaxFromInt64(t *testing.T) {
	tests := 1
	pass := 0
	gen := NewRandom(large.NewInt(5), large.NewInt(10))
